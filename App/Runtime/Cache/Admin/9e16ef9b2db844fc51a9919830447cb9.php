...
function fleshVerify(type){ 
	...
	if (type){
		$('#verifyImg').attr("src", '/index.php/Admin/Login/getCode/adv/1/'+timenow);
	}else{
		$('#verifyImg').attr("src", '/index.php/Admin/Login/getCode/'+timenow);
	}
}
//-->
</script>
...
<div id="login">
	...
	<div id="login_content">
		<div class="loginForm">
			<form method="post" action="/index.php/Admin/Login/proLogin">
				<p>
					<label>帐 &nbsp; 号：</label>
				...
				<!--<p>
					...
					<span><img id="verifyImg" SRC="/index.php/Admin/Login/getCode" onClick="fleshVerify()" border="0" alt="点击刷新验证码" style="cursor:pointer" align="absmiddle"></span>
				</p>-->
