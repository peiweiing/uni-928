...
<form id="pagerForm" action="/yyw/index.php/Admin/User/index" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="/yyw/index.php/Admin/User/del/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/listuser" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="/yyw/index.php/Admin/User/edit/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>"  width="550" height="380" target="dialog"><span>修改</span></a></li>
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="height:30px;" target="item_id" rel="<?php echo ($vo['id']); ?>">
					...
					<td style="line-height:50px;">
						<?php if($vo['avatar'] != null): ?><img src="/yyw/Public/Uploads/pic/<?php echo ($vo['avatar']); ?>" width="30" height="30" />
						<?php else: ?>
							<?php if($vo['gender'] == 1): ?><img src="/yyw/Public/Uploads/pic/male.gif" width="30" height="30" />
							<?php else: ?>
							<img src="/yyw/Public/Uploads/pic/female.gif" width="30" height="30" /><?php endif; endif; ?>
                    ...
                    <td>
                        <a style="color:blue;" href="/yyw/index.php/Admin/User/edit/id/<?php echo ($vo['id']); ?>/act/resetpass" target="dialog">修改用户密码</a>
                    </td>
