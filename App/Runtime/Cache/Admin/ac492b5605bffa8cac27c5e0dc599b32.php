...
<form id="pagerForm" action="/yyw/index.php/Admin/Article/index" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="/yyw/index.php/Admin/Article/del/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/listuser" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="/yyw/index.php/Admin/Article/edit/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>"  target="navTab"><span>修改</span></a></li>
			<li><a class="add" href="/yyw/index.php/Admin/Article/add" target="navTab"  rel="add" title="添加文章"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="112">
		...
		<tbody>
		 ...
		 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["id"]); ?>">
					...
					<td><?php echo (articletype($vo["article_type"])); ?></td>
