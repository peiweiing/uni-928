...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/PhotoAlbum';
</script>
...
<link rel="stylesheet" href="/yyw/Public/css/page.css">
    ...
    <div class="tab_list">
		<div class="tab_nv">
			<ul>
			  <li class="tab_item current"><a href="/yyw/index.php/Home/PhotoAlbum/index">我的相册</a></li>
			  <li class="tab_item"><a href="/yyw/index.php/Home/PhotoAlbum/add">上传相册</a></li>
			  <li class="tab_item"><a href="/yyw/index.php/Home/Photo/set">设置形象照</a></li>
			</ul>
		</div>
    </div>
	<!--TAB END-->   
	...
	<div id="layout">
		...
		<div id="divbox" style="background-color:white;width:550px;height:265px;position:absolute;">
			<img src="/yyw/Public/images/loading40.gif" style="height:265px;width:550px;"/>
		</div>
	</div>	
	...
	<table class="user-table table-margin lh35" border="0" cellpadding="0" cellspacing="0" width="98%">
		<tbody>
			<tr>
			<?php if($list == null): ?><td align="center">对不起，你还没有任何相册！</td>	
			<?php else: ?>		
				<td id="imageid">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div style="float:left;width:125px;height:200px;margin:10px">
							<div style="border:1px solid #ddd;width:125px;height:125px;">
								<img src="/yyw/Public//Uploads/pic/z_<?php echo ($data["uploadimage"]); ?>" style="width:125px;height:110px;cursor:pointer" alt="<?php echo ($data["info"]); ?>" title="<?php echo ($data["info"]); ?>"/>
							</div>
							<div style="margin-left:25px;margin-top:10px;color:green">
							<img src="/yyw/Public/images/ok.gif"/>
							审核通过</div>
							<a href="###" onclick="bianji(<?php echo ($data["id"]); ?>)" class="dianji">编辑</a>
							<a href="javascript:if(confirm('确认删除吗?'))window.location='/yyw/index.php/Home/PhotoAlbum/del/id/<?php echo ($data["id"]); ?>'">删除</a>
							<a href="/yyw/index.php/Home/Photo/uploadcut/id/<?php echo ($data["id"]); ?>">设置形象照</a>
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
				</td><?php endif; ?>
			</tr>		
		</tbody>		
	</table>
	<div class="badoo"><?php echo ($pageinfo); ?></div>
	<script type="text/javascript">
	...
	function bianji(id){
		$.ajax({
			url:'/yyw/index.php/Home/PhotoAlbum/edit',
			type:'post',
			data: {id:id},
			dataType:'json',
			success:function(data){
				...
				info+="<a target='_blank' href='/yyw/Public//Uploads/pic/c_"+data['uploadimage']+"'>";
				info+="<img src='/yyw/Public//Uploads/pic/z_"+data['uploadimage']+"' style='width:125px;height:110px;cursor:pointer' alt='"+data['info']+"' title='"+data['info']+"'/></a>";
				info+="</div>";
				info+="<div style='position:absolute;left:180px;top:100px'>	";
				info+="	<form action='/yyw/index.php/Home/PhotoAlbum/info/id/"+data['id']+"' method='post'>";
				info+="	<table style='width:300px;height:150px;'>";
				info+="		<tr>";
				info+="			<td>审核状态:</td>";
				info+="			<td style='color:green'><img src='/yyw/Public/images/ok.gif'/>&nbsp;正常</td>";
				info+="		</tr>";
				info+="		<tr id='shijian'>";
    ...
    <div class="clear"></div>
		...
		<div style="display: none;" class="right_kj">
			<ul>
			  <li><a href="/yyw/index.php/Home/PhotoAlbum/index">我的相册</a></li>
			  <li><a href="/yyw/index.php/Home/PhotoAlbum/add">上传相册</a></li>
			  <li><a href="/yyw/index.php/Home/Photo/index">设置形象照</a></li>
			</ul>
		</div>
	</div>
<script type="text/javascript">
