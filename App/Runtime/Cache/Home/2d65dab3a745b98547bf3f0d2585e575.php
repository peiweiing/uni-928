...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/BySee';
</script>
...
<div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  ...
		  <li class="tab_item current"><a href="/yyw/index.php/Home/BySee/index">谁看过我</a></li>
	...
	<?php if($users == null): ?><center> 对不起，你还被任何人关注！</center>
	<?php else: ?>
