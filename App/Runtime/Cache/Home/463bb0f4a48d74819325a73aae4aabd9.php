...
<div class="main_right">
	...
	<!--TAB END-->
	<link rel="stylesheet" href="/yyw/Public/css/default.css">
				...
				<tr>
					<td align="center" valign="top" width="300px">
						...
						<div style="position: absolute; z-index: 200;" id="dragDiv">
							...
							<img id="preview" src="/yyw/Public/Uploads/pic/<?php echo ($pic); ?>" style="max-width:300px;_width:expression(this.width > 300 ? '300px' : this.width);max-height:300px;_height:expression(this.height > 300 ? '300px' : this.height);position: absolute; left: 0px; top: 0px;">
						</div>
						<br>					
					</td>						
					<td align="center" valign="top">
					<form onsubmit="return doSubmit()" action="/yyw/index.php/Home/Photo/set" method="post" id="woform">
						<table class="user-table table-margin lh25" style="margin-left:10px;" cellpadding="0" cellspacing="0" border="0" width="90%">
							<tbody>
								...
								<div class="clear"> </div>	
									<span id="tupian" name="<?php echo ($pic); ?>" style="diplay:none;"><span>
								</tr>
								<tr>
									<td><b>效果预览</b></td>
								</tr>
					...
					<link rel="stylesheet" href="/yyw/Public/jcrop_zh/css/jquery.Jcrop.css" type="text/css" />
					<script type="text/javascript" src="/yyw/Public/jcrop_zh/js/jquery.Jcrop.js"></script>
					<script type="text/javascript"> 
						var picname=null;
						...
						function doJcrop(){
							$.ajax({
								url:"/yyw/index.php/Home/Photo/doCrop",
								type:"post",
								data:{picname:picname,cx:cx,cy:cy,cw:cw,ch:ch},
								dataType:'text',
								success:function(){
									$("<img name='pic' src='/yyw/Public/Uploads/pic/"+picname+"?id="+Math.random()+"'/>").Jcrop({onChange:showCoords,onSelect:showCoords}).appendTo("#caijianhou");										
								}
							});	
