...
<link rel="stylesheet" href="/yyw/Public/css/page.css">
<style>
...
<div id="page-index" class="page">
  <div class="ce member">
	...
	<div class="search_in">
		...
		<?php $__FOR_START_16437__=18;$__FOR_END_16437__=61;for($i=$__FOR_START_16437__;$i < $__FOR_END_16437__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
		...
		<option value="">不限</option>
		<?php $__FOR_START_11466__=18;$__FOR_END_11466__=61;for($i=$__FOR_START_11466__;$i < $__FOR_END_11466__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
    ...
    <div class="left">
      <div class="paper-article">
        <div class="articlesec basicsec">
          <div class="pcontent">
            <div class="prwrap">
				...
				<?php if($usertable["avatar"] != null): ?><img src="/yyw/Public/Uploads/pic/<?php echo ($usertable["avatar"]); ?>" border="0" height="227" width="185">
				...
				<?php else: ?>
					...
					<p class="offstr">
						诚信认证
						<img src="/yyw/Public/images/shenfen_h.png" title="身份证未认证">
						<img src="/yyw/Public/images/video_h.png" title="视频未认证">
						<img src="/yyw/Public/images/youxiang_h.png" title="邮箱未认证">
						<img src="/yyw/Public/images/shouji_h.png" title="手机未认证">
						<img src="/yyw/Public/images/qq_h.png" title="未绑定QQ">
						<img src="/yyw/Public/images/hunyin_h.png" title="婚姻未认证">
						<img src="/yyw/Public/images/xueli_h.png" title="学历未认证">
						<img src="/yyw/Public/images/fangchan_h.png" title="房产未认证">
						<img src="/yyw/Public/images/jiazhao_h.png" title="汽车未认证">
						<img src="/yyw/Public/images/shouru_h.png" title="收入未认证">
						<img src="/yyw/Public/images/xingxiang_h.png" title="身高未认证">
					</p>
				<div class="opwrap">
				</div>
            </div>
        ...
        <div class="infowrap">
        <div class="nickwrap">
		<p class="nick"><?php if($userinfo["gender"] == 1): ?><img src=" /yyw/Public/images/f2fde8e7d8aa2a10.gif" class="" border="0"><?php else: ?><img src=" /yyw/Public/images/87197a0d51022068.gif" class="" border="0"><?php endif; ?>  <?php echo ($usertable["username"]); ?>  </p>  <p class="next"> 
		<?php if(is_array($genders)): $i = 0; $__LIST__ = $genders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xing): $mod = ($i % 2 );++$i;?><a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($xing["userid"]); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
		下一个您可能感兴趣的人»</a></p>
		</div>
		...
		<p class="intro">内心独白：<?php echo ((isset($monologue) && ($monologue !== ""))?($monologue):"这个家伙很懒，什么都没写！"); ?></p>
            ...
            <div class="mbtnwrap">
                <div class="center_buttons"> 
					<a href="javascript:void(0);" onclick="showBox('greet',<?php echo ($id); ?>)" > <img src=" /yyw/Public/images/a2.gif"></a> 
					<a href="javascript:void(0);" onclick="showBox('message',<?php echo ($id); ?>)"> <img src=" /yyw/Public/images/a1.gif"></a> 
					<a href="javascript:void(0);" > <img onclick="toClick(<?php echo ($id); ?>)" class="dianji" src=" /yyw/Public/images/a4.gif"></a> 
					<a href="javascript:void(0);" > <img src="/yyw/Public/images/a5.gif" onclick='return doClick();'></a> 
                </div>
            </div>
        </div>
		</div>
		...
		<script type="text/javascript">
			...
			function doClick(){
				$.ajax({
					url:'/yyw/index.php/Home/Attention/insert',
					type:'post',
					dataType:'json',
					data:{ id:<?php echo ($id); ?> },
				 ...
				 <!-- <div class="JQ-slide-nav"><a class="prev" href="">‹</a><a class="next" href="#">›</a></div>-->
				  <div id="imgdiv" class="wrap">
					<ul class="JQ-slide-content imgList">
						...
						<?php else: ?>
							<?php if(is_array($photos)): $i = 0; $__LIST__ = $photos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><li> <a rel="example_group" href="/yyw/Public/Uploads/pic/<?php echo ($p["uploadimage"]); ?>" class="img" target="_blank"><img src="/yyw/Public/Uploads/pic/z_<?php echo ($p["uploadimage"]); ?>" alt="<?php echo ($p["info"]); ?>" title="<?php echo ($p["info"]); ?>"></a> <a href="" class="txt"><?php echo ($p["info"]); ?></a> </li><?php endforeach; endif; else: echo "" ;endif; endif; ?>
					</ul>
				  </div>
				</div>
			  </div> 
    ...
    <div class="right yue1">
		<h2>会员状态</h2>
		<ul class="center">
			<li>诚信星级：<?php if($userinfo["gender"] == 1): ?><img src=" /yyw/Public/images/f2fde8e7d8aa2a10.gif" class="" border="0"><?php else: ?><img src=" /yyw/Public/images/87197a0d51022068.gif" class="" border="0"><?php endif; ?>7星</li>
		...
		<a href="###">请向网站举报</a> </div>	    	  
		<h2><img src="/yyw/Public/images/crown.png"> 推荐会员</h2>
		<?php if(is_array($recuser)): $i = 0; $__LIST__ = $recuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><div class="img_list"> <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($user["userid"]); ?>" title="<?php echo ($user["user"]["username"]); ?>" target="_blank">
			<img src=" /yyw/Public/Uploads/pic/<?php echo ($user["user"]["avatar"]); ?>" class="h3h" height="96" width="80"></a><br>
			<img src="/yyw/Public/images/<?php echo ($user["icon"]); ?>" class="" border="0"><?php echo ($user["user"]["username"]); ?></div><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div id="layout" style="display:absolute;margin-left:310px;margin-top:-1570px;">
	<div class="give-topic" id="bian">
		...
		<div class="nav-tips" style="background-color:#fefce7;width:700px;height:35px;margin:0 auto;">
			...
			送给用户：<?php if($userinfo["gender"] == 1): ?><img src="/yyw/Public/images/f2fde8e7d8aa2a10.gif"  border="0"><?php else: ?><img src="/yyw/Public/images/87197a0d51022068.gif"  border="0"><?php endif; ?> <a href="#" target="_blank"><?php echo ($usertable["username"]); ?></a>&nbsp;(<?php if($userinfo["gender"] == 1): ?>男<?php else: ?>女<?php endif; ?>&nbsp;&nbsp;<?php echo ($userinfo["age"]); ?>岁&nbsp;&nbsp;
		...
		<div class="gift-list" style="margin:15px 28px 20px 20px">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class='mod-gift'>
					<a href='###' ><img class="mouseover" onclick='doSend(<?php echo ($vo["giftid"]); ?>)' src='/yyw/Public/presentimg/<?php echo ($vo["imgurl"]); ?>' height='75' width='75'>
		...
		<div class="gift-ft">
			<form action='/yyw/index.php/Home/HomePage/doSend/id/<?php echo ($usertable["id"]); ?>' target="myform" method='post' id='myform' style='margin-top:18px'>
...
<script type="text/javascript">
	...
	function doSend(id){
		$.ajax({
			url: '/yyw/index.php/Home/HomePage/loadpresent',
			type: 'post',
			data: {id:id},
			dataType: 'json',
			success:function(info){
