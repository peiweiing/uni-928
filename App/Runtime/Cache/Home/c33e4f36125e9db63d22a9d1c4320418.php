...
<div class="user_main">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  ...
		  <li class="tab_item current"><a href="/yyw/index.php/Home/PhotoAlbum/add">上传相册</a></li>
	...
	<div class="div_smallnav_content_hover">
	  ...
	  <form onsubmit="return doSubmit()" action="/yyw/index.php/Home/PhotoAlbum/upload" method="post" enctype="multipart/form-data" name="upload_form" id="upload_form">
	  <input name="halttype" value="" type="hidden">
	  <table class="user-table table-margin lh35" border="0" cellpadding="0" cellspacing="0" width="98%">
		...
		<tr>
		  ...
		  <td class="rblock" width="80%">
		    <input name="info" id="title" class="input-txt" type="text">
		...
		<tr id="id_uploadbox">
		  <td class="lblock"></td>
		  <td class="rblock"><input onclick="onClick()" id="btn_upload" value="开始上传" class="button-green" type="submit"></td>
		</tr>
		<!-- 上传提示 -->
		<tr>
		  <td class="lblock"></td>
		  <td id="id_loadingbar" style="display:none;" class="rblock"><img src="/yyw/Public/images/uploading.gif" border="0" height="19" width="220"> 照片上传中，请稍后...</td>
		</tr>
		<script type="text/javascript">
			function doSubmit(){
				var loadid = document.getElementById("id_loadingbar");
				var uploadid = document.getElementById("id_uploadbox");
				var sf_upfile = document.getElementById("sf_upfile").value;
		  ...
		  <td colspan="2" align="left">
		    <div style="line-height:24px;">
			 <strong>温馨提示：</strong><br>
			  ...
			  仅支持PNG，JPG，JPEG，GIF格式，3M以下文件；<br>
