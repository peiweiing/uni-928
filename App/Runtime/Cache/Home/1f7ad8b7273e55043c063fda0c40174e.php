...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/Present';
</script>
...
<link rel="stylesheet" href="/yyw/Public/css/page.css">
    ...
    <div class="tab_list">
		<div class="tab_nv">
			<ul>
			  <li class="tab_item current"><a href="###">收到的礼物</a></li>
			  <li class="tab_item"><a href="/yyw/index.php/Home/Present/send">送出的礼物</a></li>
			</ul>
		</div>
    </div>
	<!--TAB END-->
    ...
    <div class="div_smallnav_content_hover" id="nav_lv_detail">
	    ...
	    <tbody>
			<tr>
			<td align="center" id="tishi" style="display:none;">对不起，你还没收到任何礼物。</td>
			</tr>
			<script type="text/javascript">
				var regif = <?php echo $gifts ?>;
			...
			<ul>
			<?php if(is_array($reinfo)): $i = 0; $__LIST__ = $reinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pre): $mod = ($i % 2 );++$i;?><li>
					<img src="/yyw/Public/presentimg/<?php echo ($pre["fromimg"]); ?>" height="120" width="120">
					<div><?php echo ($pre["giftname"]); ?></div>
					<div class="cc"><?php echo (date("Y-m-d",$pre["sedtime"])); ?><br/><a class="cc" href="javascript:if(confirm('确认删除吗?'))window.location='/yyw/index.php/Home/Present/del/id/<?php echo ($pre["giftid"]); ?>'">删除</a></div>

					赠送人：<a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($pre["fromuserid"]); ?>"><?php echo ($pre["fromname"]); ?></a><br>																				
					(<?php if($pre["fromsex"] == 1): ?>男<?php else: ?>女<?php endif; ?>&nbsp;<?php echo ($pre["fromage"]); ?>岁&nbsp;
					<?php if($pre["fromstatus"] == 1): ?>单身
						<?php elseif($pre["fromstatus"] == 2): ?>已婚
						<?php elseif($pre["fromstatus"] == 3): ?>离异
						<?php elseif($pre["fromstatus"] == 4): ?>丧偶<?php endif; ?>	&nbsp;<?php echo ($pre["fromcity"]); ?>)
	...
	<div id="liwu"	style="overflow: hidden; display: block; height: 1.15755px; padding-top: 0px; margin-top: 0.221902px; padding-bottom: 0px; margin-bottom: 0px;" class="right_kj">
    <ul>
		<li><a href="#">收到的礼物</a></li>
		<li><a href="/yyw/index.php/Home/Present/send">送出的礼物</a></li>
	</ul>
	</div>
