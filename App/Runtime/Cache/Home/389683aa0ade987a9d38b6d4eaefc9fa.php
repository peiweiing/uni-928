...
<div class="search_top">
	...
	<div class="search_in">
		...
		<?php $__FOR_START_4379__=18;$__FOR_END_4379__=61;for($i=$__FOR_START_4379__;$i < $__FOR_END_4379__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
		...
		<option value="">不限</option>
		<?php $__FOR_START_12984__=18;$__FOR_END_12984__=61;for($i=$__FOR_START_12984__;$i < $__FOR_END_12984__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
    ...
    <div class="left ri">
      <div class="search_sort">
        <div id="rank" class="search_sle">你的位置：<a  href="/yyw/index.php/Home/Index">首页</a> &gt;&gt; <a  href="/yyw/index.php/Home/DiaryShow/index">心情日记</a> &gt;&gt; 正文 </div>
      </div>
      <div class="content">
        <h1><?php echo ($info["title"]); ?></h1>
        <div class="jian">
		<?php if($info["weather"] != null): ?>天气：<?php echo ($info["weather"]); ?>&nbsp;&nbsp;<?php endif; ?>
		<?php if($info["feel"] != null): ?>天气：<?php echo ($info["feel"]); ?>&nbsp;&nbsp;<?php endif; ?>发表时间：<?php echo (date("m-d i:s",$info["addtime"])); ?>  人气：<font id="json_hits"><?php echo ($info["views"]); ?></font>&nbsp;&nbsp;&nbsp;&nbsp;<a  href="#comment">我要评论</a></div>
        <div class="real">

	      <div class="topj" style="line-height:40px;"> 
		  <a  href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($user["id"]); ?>" class="topimg">
			<img src="/yyw/Public/Uploads/pic/<?php echo ($user["avatar"]); ?>" border="0" height="227" width="185">
		  </a> 发表人：
			<?php if($user["gender"] == '男'): ?><img src="/yyw/Public/images/f2fde8e7d8aa2a10.gif" class="" border="0"><?php else: ?><img src="/yyw/Public/images/87197a0d51022068.gif" class="" border="0"><?php endif; ?>
		  <a  href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($user["id"]); ?>"><?php echo ($user["username"]); ?></a>
		  <br>
            <span><?php echo ($user["age"]); ?>岁 <?php echo ($user["provinceid"]); ?> <?php echo ($user["cityid"]); ?> <?php echo ($user["height"]); ?>CM <?php echo ($user["marrystatus"]); ?> <?php echo ($user["salary"]); ?></span><br>
			<a  href="javascript:void(0);" class="sg" onclick="showBox('message',<?php echo ($user["id"]); ?>)" ><img src="/yyw/Public/images/f.gif"></a>
			<a  href="javascript:void(0);" class="sg" onclick="showBox('greet',<?php echo ($user["id"]); ?>)"  ><img src="/yyw/Public/images/zh.gif"></a>
		  </div>
        ...
        <div class="comments">
		  ...
		  <input name="id" id="diaryid" value="<?php echo ($info["id"]); ?>" type="hidden">
		  <table style="line-height:25px;" border="0" cellpadding="5" cellspacing="5" width="100%">
			...
			<tr>
			  <td>验证码：
			  <input id="checkcode" name="checkcode" class="checkcode" maxlength="6" type="text"> <img id="getCode" onclick="refeshCode()" src="/yyw/index.php/Home/Login/getCode" align="middle"> <a  href="javascript:void(0);" onclick="refeshCode()"> 换一张</a>
			  </td>
			</tr>
			<tr>
			  <?php if($_SESSION['user']== null): ?><td>
			  	只有登录会员才可以查看评论和回复! <a  href="/yyw/index.php/Home/Login/index" >登录</a> 或者 <a  href="/yyw/index.php/Home/Login/register">免费注册</a>
			  </td>
			  <?php else: ?>
			  <td>
...
<script type="text/javascript">
	...
	$('.comment_span').live('mouseover',function(){
		...
		if(cmuserid=="<?php echo ($_SESSION['user']['id']); ?>"){
	...
	$('.comment_reply').live("click",function(){
		...
		if(touserid == "<?php echo ($_SESSION['user']['id']); ?>"){
			proMess('不可以对自己回复');
    ...
    <div class="right yue1">
		<h2>热门日记</h2>
		<ul class="list_blog">
		<?php if(is_array($hotdiary)): $i = 0; $__LIST__ = $hotdiary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?><li><a  href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($hot["id"]); ?>" title="<?php echo ($hot["title"]); ?>"><?php echo ($hot["title"]); ?></a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
		<h2><img src="/yyw/Public/images/crown.png"> 推荐会员</h2>
		<?php if(is_array($recuser)): $i = 0; $__LIST__ = $recuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rec): $mod = ($i % 2 );++$i;?><div class="img_list">
			<a  href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($rec["userid"]); ?>" title="<?php echo ($rec["user"]["username"]); ?>" target="_blank">
			<img src="/yyw/Public/Uploads/pic/<?php echo ($rec["user"]["avatar"]); ?>" class="h3h" height="96" width="80">
			</a><br>
			<img src="/yyw/Public/images/<?php echo ($rec["icon"]); ?>"/>
			<?php echo ($rec["user"]["username"]); ?>
