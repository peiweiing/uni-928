...
<div id="page-index" class="page">
 ...
 <div class="ce member">
	...
	<div class="search_in">
		...
		<?php $__FOR_START_20501__=18;$__FOR_END_20501__=61;for($i=$__FOR_START_20501__;$i < $__FOR_END_20501__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
		...
		<option value="">不限</option>
		<?php $__FOR_START_12074__=18;$__FOR_END_12074__=61;for($i=$__FOR_START_12074__;$i < $__FOR_END_12074__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
    ...
    <div class="left blog">
      ...
      <div class="ad">
        <div class="leftad">
	    	<a><img src="/yyw/Public/images/abc42bd94ed9d3a1.gif" title="" border="0" height="225" width="270"></a>
	    	<a><img src="/yyw/Public/images/53d6a915f484f50a.gif" title="" border="0" height="65" width="270"></a>
	    </div>
        <div class="le2">
          ...
          <ul class="rzul">
			<?php if(is_array($newdiary)): $i = 0; $__LIST__ = array_slice($newdiary,0,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($new["id"]); ?>"><span> ▪ </span><?php echo ($new["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
          <div class="rztu">
		    			          </div>
          <span class="neww"> <img src="/yyw/Public/images/new_diary.png"></span> </div>
        <div style="clear:both"></div>
      </div>
      ...
      <div class="aa">
        <div class="a1">
          <h2>
            <div>⿻ <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/1" target="_blank">婚恋课堂</a></div>
            <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/1" class="mo" target="_blank">更多&gt;&gt;</a>
		  </h2>
          <ul>
		  <?php if(is_array($hunlian)): $i = 0; $__LIST__ = $hunlian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hunlian): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($hunlian["id"]); ?>" target="_blank"><span> ▪ </span><?php echo ($hunlian["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
        </div>
        <div class="a2">
          <h2>
            <div>⿻ <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/2" target="_blank">爱情故事</a></div>
            <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/2" class="mo" target="_blank">更多&gt;&gt;</a></h2>
          <ul>
			<?php if(is_array($aiqing)): $i = 0; $__LIST__ = $aiqing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aiqing): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($aiqing["id"]); ?>" target="_blank"><span> ▪ </span><?php echo ($aiqing["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
        </div>
		<div style="clear:both"></div>
        <div class="a1">
          <h2>
            <div>⿻ <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/3" target="_blank">两性私语</a></div>
            <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/3" class="mo" target="_blank">更多&gt;&gt;</a></h2>
          <ul>
			<?php if(is_array($liangxing)): $i = 0; $__LIST__ = $liangxing;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$liangxing): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($liangxing["id"]); ?>" target="_blank"><span> ▪ </span><?php echo ($liangxing["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
        </div>
        <div class="a2">
          <h2>
            <div>⿻ <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/4" target="_blank">情感物语</a></div>
            <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/4" class="mo" target="_blank">更多&gt;&gt;</a></h2>
          <ul>
			<?php if(is_array($qinggan)): $i = 0; $__LIST__ = $qinggan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qinggan): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($qinggan["id"]); ?>" target="_blank"><span> ▪ </span><?php echo ($qinggan["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
        </div>
		<div style="clear:both"></div>
        <div class="a1">
          <h2>
            <div>⿻ <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/5" target="_blank">生活点滴</a></div>
            <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/5" class="mo" target="_blank">更多&gt;&gt;</a></h2>
          <ul>
			<?php if(is_array($shenghuo)): $i = 0; $__LIST__ = $shenghuo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shenghuo): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($shenghuo["id"]); ?>" target="_blank"><span> ▪ </span><?php echo ($shenghuo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
        </div>
        <div class="a2">
          <h2>
            <div>⿻ <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/6" target="_blank">文学随笔</a></div>
            <a href="/yyw/index.php/Home/DiaryShow/diaryList/catid/6" class="mo" target="_blank">更多&gt;&gt;</a></h2>
          <ul>
			<?php if(is_array($wenxue)): $i = 0; $__LIST__ = $wenxue;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wenxue): $mod = ($i % 2 );++$i;?><li><a href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($wenxue["id"]); ?>" target="_blank"><span> ▪ </span><?php echo ($wenxue["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			<div style="clear:both"></div>
          </ul>
        </div>
      </div>
    ...
    <div class="right">
      <h2>猜你喜欢</h2>
	  <?php if(is_array($gueuser)): $i = 0; $__LIST__ = $gueuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gue): $mod = ($i % 2 );++$i;?><div class="iemg"> 
	    <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($gue["userid"]); ?>" target="_blank"><img src="/yyw/Public/Uploads/pic/<?php echo ($gue["user"]["avatar"]); ?>" border="0" height="96" width="80"></a>
        <img src="/yyw/Public/images/<?php echo ($gue["icon"]); ?>" class="" border="0">
		<a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($gue["userid"]); ?>" title="<?php echo ($gue["user"]["username"]); ?>" target="_blank"><?php echo ($gue["user"]["username"]); ?></a><br>
	  </div><?php endforeach; endif; else: echo "" ;endif; ?>   
	  <div style="clear:both;"></div>
      <h2 style="margin-top:5px;">最新日记</h2>
      <ul class="list_blog">
		<?php if(is_array($newdiary)): $i = 0; $__LIST__ = $newdiary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($new["id"]); ?>" title="<?php echo ($new["title"]); ?>"><?php echo ($new["title"]); ?></a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
	  </ul>
    </div>
    <div style="clear:both;"></div>
  </div>
