...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/See';
</script>
...
<div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  ...
		  <li class="tab_item current"><a href="/yyw/index.php/Home/See/index">我看过谁</a></li>
	    </ul>
	  </div>
    </div>
	<!--TAB END-->
	...
	<?php if($users == null): ?><center><b> 对不起，你还被任何人关注！</b></center>
	<?php else: ?>
	<?php if(is_array($users)): foreach($users as $k=>$vo): ?><div class="myfan_item">
	    <div class="myfan_logo">
		  <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($vo["id"]); ?>"><img width="50" height="60" src="/yyw/Public/Uploads/pic/<?php echo ($vo["avatar"]); ?>" class="user-logo">
			</a>
		</div>
	    <div class="myfan_info">
		  <div style="width:100%;">
		    <strong><a target="_blank" href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["username"]); ?></a></strong>
			<div id="tips_listen_184823" class="myfan-button"></div>
			<span><a href="javascript:void(0)" onclick="showBox('message',<?php echo ($vo["id"]); ?>);">发信件</a></span>
			<span><a href="javascript:void(0)" onclick="showBox('greet',<?php echo ($vo["id"]); ?>);">打招呼</a></span>
		  </div>
		  <div class="myfan_x">
			<?php echo ($res["$k"]["ageyear"]); ?>岁 <?php echo ($res["$k"]["marrystatus"]); ?> <?php echo ($res["$k"]["height"]); ?>CM&nbsp;&nbsp;
		    <?php echo ($city1["$k"]["name"]); ?> <?php echo ($city["$k"]["name"]); ?>&nbsp;&nbsp;
		    <?php echo ($res["$k"]["education"]); ?>&nbsp;&nbsp;<?php echo ($res["$k"]["salary"]); ?>
		  </div>
		  <div class="myfan_d">
		  		  <?php echo ($res["$k"]["monolog"]); ?>
		  		  </div>
		</div>
		<div class="clear"></div>
