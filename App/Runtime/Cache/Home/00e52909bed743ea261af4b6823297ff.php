...
<div id="page-index" class="page">
  ...
  <div class="indexbg">
	...
	<div class="search_in">
		...
		<?php $__FOR_START_2642__=18;$__FOR_END_2642__=61;for($i=$__FOR_START_2642__;$i < $__FOR_END_2642__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
		...
		<option value="">不限</option>
		<?php $__FOR_START_28909__=18;$__FOR_END_28909__=61;for($i=$__FOR_START_28909__;$i < $__FOR_END_28909__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
		</select>
				...
				<div style="width: 700px; height: 290px; overflow: hidden; position: relative;" id="KSS_moveBox">
                    <div style="float: left;" id="KSS_XposBox">
                        ...
                        <ul style="float: left;position:absolute;" id="KSS_content">
                            <a href="#"><img src="/Public/images/441966a33680197b.jpg" alt="成功牵手 红娘带我迈向幸福" height="290" width="700"></a>
                            <a href="#"><img src="/Public/images/f88b0b8a7a9cd663.jpg" alt="爱要大声说出来" height="290" width="700"></a>
                            <a href="#"><img src="/Public/images/dd9269073dad452a.jpg" alt="诚信交友" height="290" width="700"></a>
                        </ul>
        ...
        <div class="huar">
            ...
            <?php if(empty($_SESSION['user'])): ?><div class="llgo">
                ...
                <form method="post" action="/index.php/Home/Login/login" name="login_form" id="nav_loginForm">
                    ...
                    <p class="fitem-btn">
                        ...
                        <a class="button button-minor button-reg" href="/index.php/Home/Login/register">免费注册</a>
                    </p>
                </form>
                <!-- --------------------------------------------------- -->
                <script type="text/javascript">
                ...
                <div class="hezuo_pt">
                    ...
                    <p class="hezuo_dl">
                        <a href="#"><img src="/Public/images/qq.gif" /> QQ登录</a>
                        <a href="#"><img src="/Public/images/sina.gif" /> 新浪微博登录</a>
                ...
                <div class="login_gooo">
                        <div class="login_xxxxx">
							<?php if($_SESSION['user']['avatar']!= null): ?><a href="#" class="login_gohead" title="<?php echo ($userInfo['username']); ?>">
									<img src="/Public/Uploads/pic/<?php echo ($_SESSION['user']['avatar']); ?>" border="0" height="227" width="185">
								</a>
							<?php else: ?>
								<?php if($_SESSION['user']['gender']== 1): ?><a href="#" class="login_gohead" title="<?php echo ($userInfo['username']); ?>">
									<img src="/Public/images/male.gif" border="0" height="227" width="185">
								</a>
								<?php else: ?>
								<a href="#" class="login_gohead" title="<?php echo ($userInfo['username']); ?>">
									<img src="/Public/images/female.gif" border="0" height="227" width="185">
								</a><?php endif; endif; ?>
                            <div class="login_xinxi">
                                ...
                                <div>相册：<?php echo ($albumTotal); ?> 张 <a href="<?php echo U('PhotoAlbum/index');?>">上传</a></div>
                                <div><a href="/index.php/Home/Login/logout">退出登录</a>&nbsp;</div>
                            </div>
                            <div class="c"></div>
                        </div>
                        <div class="login_hudong">

                            <div><img src="/Public/images/y1.gif">信件：(<a href="/index.php/Home/Message/index/status/unread" class="no_read_message"></a>)</div>
                            <div><img src="/Public/images/y2.gif">人气：(<a href="/index.php/Home/HomePage/index/id/<?php echo ($views["id"]); ?>"><?php echo ($views["views"]); ?></a>)</div>
                            <div><img src="/Public/images/y3.gif">日记：(<a href="/index.php/Home/Diary/index"><?php echo ($diarytotal); ?></a>)</div>
                            <div><img src="/Public/images/y4.gif">礼物：(<a href="/index.php/Home/Present/index"><?php echo ($present); ?></a>)</div>
                        </div>
						<script type="text/javascript">
							noReadMessage();
						</script>
                        <div class="login_goge"><a href="/index.php/Home/User/view/act/userInfo">进入个人中心</a></div>
                </div>
            </div><?php endif; ?>
  ...
  <div class="index1">
		<div class="left3">
			...
			<h2 class="hh3">
				...
				<a href="/index.php/Home/UserList/index" class="more3">查看更多&gt;&gt;</a> 
			</h2>
...
<script type="text/javascript">
			...
			<div class="left3list" name="female" style="display:block;" id="tab_label_0">
				<ul> 
					<?php if(is_array($female)): $i = 0; $__LIST__ = $female;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$female): $mod = ($i % 2 );++$i;?><li>
						<a href="/index.php/Home/HomePage/index/id/<?php echo ($female["userid"]); ?>" target="_blank">
							<img src="/Public/Uploads/pic/<?php echo ($female["user"]["avatar"]); ?>" title="<?php echo ($female["user"]["username"]); ?>" height="110px" width="90px">
						</a>
						<div class="areaf"> 
			...
			<div class="left3list" name="male" style="display:none;" id="tab_label_0">
				<ul> 
					<?php if(is_array($male)): $i = 0; $__LIST__ = $male;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$male): $mod = ($i % 2 );++$i;?><li>
						<a href="/index.php/Home/HomePage/index/id/<?php echo ($male["userid"]); ?>" target="_blank">
							<img src="/Public/Uploads/pic/<?php echo ($male["user"]["avatar"]); ?>" title="<?php echo ($male["user"]["username"]); ?>" height="110px" width="90px">
						</a>
						<div class="areaf"> 
			...
			<div class="left3list" name="new" style="display:none;" id="tab_label_0">
				<ul> 
					<?php if(is_array($newuser)): $i = 0; $__LIST__ = $newuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li>
						<a href="/index.php/Home/HomePage/index/id/<?php echo ($new["id"]); ?>" target="_blank">
							<img src="/Public/Uploads/pic/<?php echo ($new["avatar"]); ?>" title="<?php echo ($new["uusername"]); ?>" height="110px" width="90px">
						</a>
						<div class="areaf"> 
  ...
  <div class="bigline"></div>
      ...
      <div class="inad1"><a><img src="/Public/images/0b90808b85fb02ef.jpg" title="" border="0" height="90" width="976"></a></div>
  <div class="bigline"></div>
	...
	<div class="index6">
		<div class="left4">
			...
			<label>
				...
				<a class="more3" href="/index.php/Home/UserList/index/type/mon">查看更多&gt;&gt;</a> 
			</h2>
			...
			<?php if(is_array($monuser)): $i = 0; $__LIST__ = $monuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mon): $mod = ($i % 2 );++$i;?><li>
					<a class="head5" href="/index.php/Home/HomePage/index/id/<?php echo ($mon["userid"]); ?>">
						<img src="/Public/Uploads/pic/<?php echo ($mon["user"]["avatar"]); ?>" title="<?php echo ($mon["user"]["username"]); ?>" alt="<?php echo ($mon["user"]["username"]); ?>" height="135px" width="112px">
					</a>
					<div class="headr5">
						<span class="headr5_2"><a href="/index.php/Home/HomePage/index/id/<?php echo ($mon["userid"]); ?>"><?php echo ($mon["user"]["username"]); ?></a></span>
						<img src="/Public/images/<?php echo ($mon["icon"]); ?>" class="" border="0">
						<div class="headr5_1"> <?php echo ($mon["age"]); ?> 岁　<?php echo ($mon["provinceid"]); ?> <?php echo ($mon["cityid"]); ?> <?php echo ($mon["education"]); ?><br>
						  <?php echo ($mon["mon"]); ?>
						  <a href="/index.php/Home/HomePage/index/id/<?php echo ($mon["userid"]); ?>" target="_blank">查看资料</a>
						</div>
						<div class="headr5_3"> 
							<span class="d3">
		...
		<div class="right4">
			<h2 class="righth4">
				<span>最热日记</span>
				<a href="/index.php/Home/DiaryShow/index" target="_blank">更多&gt;&gt;</a>
			</h2>
			<div class="qiulist">
				<?php if(is_array($hotdiary)): $i = 0; $__LIST__ = $hotdiary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?><div class="r4list">
					<a href="/index.php/Home/DiaryShow/single/id/<?php echo ($hot["id"]); ?>" target="_blank" title="<?php echo ($hot["title"]); ?>"><?php echo ($hot["title"]); ?></a>
            ...
            <h2 class="righth4" style="background:#f0edeb;">
				<span>网站公告</span>
				<a href="/index.php/Home/Notice/lists" target="_self">更多&gt;&gt;</a>
			</h2>
			<div class="qiulist">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="r4list">
					<a href="/index.php/Home/Notice/detail/id/<?php echo ($vo['id']); ?>" target="_self" title="<?php echo ($vo['title']); ?>"><?php echo ($vo['title']); ?></a>
				</div><?php endforeach; endif; else: echo "" ;endif; ?>
				
			</div>
            
			<div class="qiutu">
				<a><img src="/Public/images/22f234bcef1ae435.jpg" title="" border="0" height="120" width="233"></a>
			</div>
		  
			<div class="w230"><a><img src="/Public/images/cac9dc3e954d433e.jpg" title="" border="0" height="81" width="233"></a>
			</div>
		  
			<div class="index_info_box">	
				<a href="#" class="infot"><img src="/Public/images/ads3.jpg"></a>
	...
	<div class="bigline"></div>
	<div class="shouyegg">
		<a href="<?php echo ($advertising["link"]); ?>" target="_blank"><img src="/Public/images/0b90808b85fb02ef.jpg" style="width:980;height:90" title="<?php echo ($advertising["title"]); ?>" alt="<?php echo ($advertising["title"]); ?>"></a>
	</div>
	<div class="bigline"></div>
