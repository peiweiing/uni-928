...
<div class="main_right">
	...
	<div class="tab_list">
		<div class="tab_nv">
			<ul>
				<li class="tab_item current"><a href="/yyw/index.php/Home/Diary/index">我的日记</a></li>
				<li class="tab_item"><a href="/yyw/index.php/Home/Diary/add">发表日记</a></li>
				<li class="tab_item">编辑日记</li>
			</ul>
		</div>
	</div>
	<!--TAB END-->
<?php if(empty($diaryList)): ?><div class="div_smallnav_content_hover">
...
<?php else: ?>
<?php if(is_array($diaryList)): $i = 0; $__LIST__ = $diaryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$diary): $mod = ($i % 2 );++$i;?><div class="div_smallnav_content_hover">
	<div class="diary_item">
		<div class="item_left" style="float:left;">
			<img src="/yyw/Public/images/<?php if($diary["power"] == 1): ?>unlock.png<?php else: ?>lock.png<?php endif; ?>" title="公开" width='18' toc="unlock">
		</div>
		
		<div class="item_right" style="float:left;margin-left:10px;" id="mydiary_140">
			
			<a href="/yyw/index.php/Home/Diary/edit/id/<?php echo ($diary["id"]); ?>"><strong><?php echo ($diary["title"]); ?></strong></a><m>[<?php echo ($diary["catid"]["catname"]); ?>]</m>&nbsp;&nbsp;&nbsp;&nbsp;<span class="cc"><?php echo (date("Y-m-d H:i:s",$diary["addtime"])); ?></span>&nbsp;&nbsp;&nbsp;
			(
			<font color="green"><?php if($diary["status"] == 2): ?>已通过<?php else: ?>审核中<?php endif; ?></font>
			)
		</div>
		<div class="diary_gn" style="float:right;" id="mydiary_140_cz">浏览(<?php echo ($diary["views"]); ?>)&nbsp;&nbsp;&nbsp;评论(<?php echo ($diary["comment"]); ?>)&nbsp;&nbsp;&nbsp;
		<a href="/yyw/index.php/Home/Diary/edit/id/<?php echo ($diary["id"]); ?>">编辑</a>&nbsp;&nbsp;&nbsp;
		<a href="javascript:void(0);" id='<?php echo ($diary["id"]); ?>' class="diarydel">删除</a>
		</div>
		<div class="clear"></div>
	</div>
