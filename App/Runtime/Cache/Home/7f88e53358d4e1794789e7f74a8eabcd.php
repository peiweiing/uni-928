...
<div class="reg_left_title">
        ...
        <!-- 扣不下背景图片只有。。生生的放在这 -->
        <img src="/yyw/Public/images/title.png" width="270" height="45" />
      </div>
	  <form method="post" action="/yyw/index.php/Home/Login/insert" name="register_form" onsubmit="return checkSubmit()" id="register_form">
        <div class="form_box">
          ...
          <div class="form_li">
		    ...
		    <div class="form_li">
                ...
                <!-- /yyw/index.php/Home/Login/getCode -->
                <img id="getCode" onclick="refeshCode()" src="/yyw/index.php/Home/Login/getCode" style="position:relative;top:12px;" />
                 
                <a href="javascript:void(0);" onclick="refeshCode()" id="refeshCode"> 换一张</a>
                
                
                <!-- document.getElementById('code').src='/yyw/index.php/Home/Login/getCode' -->
          ...
          <div class="bitian">
            ...
            <script type="text/javascript">
                $(function(){
                    //加载注册城市街道信息
                    var upid = 0;
                    myAjax('/yyw/index.php/Home/Login/addrAjax', 'get', 'json', upid, function(data){
                    ...
                    $("#provinceid").change(function(){
                        ...
                        if(id>0){
                            //调用自定义ajax函数
                            myAjax('/yyw/index.php/Home/Login/addrAjax', 'get', 'json', {upid:id}, function(data){
                                if(data == null) {
                                    return;
                                }
          ...
          <div class="form_li">
            ...
            <div class="tijiao"> 
              ...
              <!-- <button class="button_register" style="pointer:hand;" type="button" onclick="return checkreg();">免费注册</button> -->
                ...
                <input type="submit" value="" style="width:113px;border:none;background:url(/yyw/Public/images/register.png) no-repeat;" />
              </a> 
          </div>
    ...
    <div class="right"> 
	  <a class="login" href="/yyw/index.php/Home/Login/index">已有帐号？ 点此登录&gt;&gt;</a>
            <ul class="list">
        <li class="first"> 
        ...
        <script type="text/javascript">
            ...
            function ajaxInfo(item){
                ...
                myAjax("/yyw/index.php/Home/Login/unique", 'get', 'text', data, function(data){
                    if(data != 0){
