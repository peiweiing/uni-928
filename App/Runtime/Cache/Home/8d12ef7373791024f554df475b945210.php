...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/Message';
</script>
...
<div class="tab_list">
  <div class="tab_nv">
	<ul>
	  ...
	  <li class="tab_item current"><a href="/yyw/index.php/Home/Message/send">已发信件</a></li>
	  <li class="tab_item"><a href="/yyw/index.php/Home/Greet/index">收到问候</a></li>
    ...
    <div class="div_smallnav_content_hover">
	  <div class="nav-tips">
	    <div class="span">已发信件<?php echo ((isset($total) && ($total !== ""))?($total):'0'); ?>封</div>
	    筛选排序：
	    <img src="/yyw/Public/images/tips-msg01.gif"><a href="/yyw/index.php/Home/Message/send/status/unread">对方未读</a> &nbsp;&nbsp;&nbsp;
	    <img src="/yyw/Public/images/tips-msg02.gif"><a href="/yyw/index.php/Home/Message/send/status/read">对方已读</a>&nbsp;&nbsp;&nbsp;
	  </div>
	  <table class="table">
		<tbody>
		<tr>
		  ...
		  <td width="12%">状态</td>
		  <td width="10%"></td>
		  <td width="40%" align="left">收信人信息</td>
		  <td width="10%">操作</td>
		  <td width="21%">时间</td>
		</tr>
		<?php if($total == 0): ?><tr>
			<td colspan="6" class="hback" align="center">对不起， 暂没有信件。</td>
		</tr>
		<?php else: ?>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr style="width:100%;height:80px;">
				...
				<td width="60"><a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($list["user"]["userid"]); ?>" target="_blank"><img src="/yyw/Public/Uploads/pic/<?php echo ($list["user"]["avatar"]); ?>" class="table-inside-img" height="48" width="40"></a></td>
				  <td align="left">
					  <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($list["user"]["userid"]); ?>" target="_blank"><?php echo ($list["user"]["username"]); ?></a><br>
				...
				<td><a href="/yyw/index.php/Home/Message/sendView/id/<?php echo ($list["id"]); ?>" class="letter-button5"></a></td>
			...
			<tr>
				<td colspan="5" style="text-align:left;">
					...
					<input type="submit" value="删除选定" class="button-red" onclick="messageDel('Message','senddel')"/>
				</td>
			</tr><?php endif; ?>
		</tbody>
	</table>
