...
<script type="text/javascript">
	...
	var __url__ = '/index.php/Home/User';
</script>
<script type="text/javascript" src="/Public/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/Public/js/usercp.js"></script>
<script type="text/javascript" src="/Public/js/messageChoose.js"></script>
<script type="text/javascript" src="/Public/js/proMess.js"></script>
<script type="text/javascript" src="/Public/js/diaryAdd.js"></script>
<script type="text/javascript" src="/Public/js/checkReg.js"></script>
<script type="text/javascript" src="/Public/js/checkDiary.js"></script>
...
<div class="user_fixed-bar" id="user_header">
	<div class="user_containerss"> 
		<a href="/index.php/Home/Index/index"><img src="/Public/images/logo.gif" class="user_logo"></a>
		<ul class="user_top_menu">
		  <li><a href="/index.php/Home/UserList/index">搜索会员</a></li>
		</ul>
		<div class="user-top-setting">
			<div class="user-top-avatar">
			<?php if($_SESSION['user']['avatar']!= null): ?><a href="#" title="设置形象照">
					<img src="/Public/Uploads/pic/<?php echo ($_SESSION['user']['avatar']); ?>" border="0" height="25" width="25">
				</a>
			<?php else: ?>
				<?php if($_SESSION['user']['gender']== 1): ?><a href="#" title="设置形象照">
					<img src="/Public/images/male.gif" border="0" height="25" width="25">
				</a>
				<?php else: ?>
				<a href="#" title="设置形象照">
					<img src="/Public/images/female.gif" border="0" height="25" width="25">
				</a><?php endif; endif; ?>
			</div>
			...
			<div class="user-top-tips">
				<div id="emailContent" class="user-top-tips-list">
					<a href="/index.php/Home/Message/index/status/1">未读信件(<span class="no_read_message"></span>)</a>
			  
					<a href="/index.php/Home/Greet/index/status/1">未读问候(<span class="no_read_hibox"></span>)</a>
			  
					<a href="/index.php/Home/SystemMessage/index">系统消息(<?php if($unRead != null): echo ($unRead); else: ?>0<?php endif; ?>)</a>
				</div>
				<div id="email" class="user-top-tips-ol" name="tip_title">
				  <span class="user-top-tips-btn">信件&nbsp;<img src="/Public/images/jiantou.gif"></span>
				</div>
			</div>
			<div class="user-top-set"><a href="/index.php/Home/User/editPass">修改密码</a></div>
			<div class="user-top-logout"><a href="/index.php/Home/Login/logout">退出</a></div>
		</div>
	</div>
</div>
<div class="user_main">
    ...
    <div class="user_main_left">
		...
		<div class="user_info_">
			...
			<?php if($_SESSION['user']['avatar']!= null): ?><a href="#" title="设置形象照">
					<img src="/Public/Uploads/pic/<?php echo ($_SESSION['user']['avatar']); ?>" border="0" height="58" width="48">
				</a>
			<?php else: ?>
				<?php if($_SESSION['user']['gender']== 1): ?><a href="#" title="设置形象照">
					<img src="/Public/images/male.gif" border="0" height="58" width="48">
				</a>
				<?php else: ?>
				<a href="#" title="设置形象照">
					<img src="/Public/images/female.gif" border="0" height="58" width="48">
				</a><?php endif; endif; ?>
			</div>
		...
		<div class="user-info-tip">
		  <p>
			<a href="/index.php/Home/HomePage/index/id/<?php echo ($_SESSION['user']['id']); ?>" target="_blank">预览我的个人主页</a><br>
		...
		<div class="user-info-tip">
			...
			<table border="0" cellpadding="0" cellspacing="0" align="center">
			  <tbody><tr>
				<td class="numberInbox">
					<div class="numberR"><a href="/index.php/Home/Message/index/status/1" class="no_read_message"></a></div>
				</td>
			  </tr>
			  <tr>
				<td height="30">收件箱</td>
		  ...
		  <div class="user-info-tip-right">
			<table border="0" cellpadding="0" cellspacing="0" align="center">
			  <tbody><tr>
				<td class="numberInbox">
					<div class="numberR"><a href="/index.php/Home/Greet/index/status/1" class="no_read_hibox"></a></div>
				</td>
			  </tr>
			  <tr>
				<td height="30">打招呼</td>
		...
		<div class="user_menu_item">
		  <ul>
			<li><img src="/Public/images/562879.png"><a href="/index.php/Home/User/view/act/userInfo">交友帐号</a></li>
		  </ul>
		  <div class="clear"></div>
		</div>
		<div class="user_menu_hr"></div>
		...
		<div class="user_menu_item">
		  <ul>
			<li><img src="/Public/images/562810.png"><a href="/index.php/Home/Message/index"><b><font color="red">我的信件</font></b></a></li>
			<li><img src="/Public/images/562717.png"><a href="/index.php/Home/Greet/index">我的问候</a></li>
			<li><img src="/Public/images/562812.png"><a href="/index.php/Home/SystemMessage/index">系统消息</a></li>
			<li><img src="/Public/images/562785.png"><a href="/index.php/Home/Present/index">我的礼物</a></li>
			<li><img src="/Public/images/562709.png"><a href="/index.php/Home/Attention/index"><b><font color="red">我的关注</font></b></a></li>
			<li><img src="/Public/images/562808.png"><a href="/index.php/Home/ByAttention/index">我的粉丝</a></li>
			<li><img src="/Public/images/562779.png"><a href="/index.php/Home/BySee/index">谁看过我</a></li>
			<li><img src="/Public/images/562757.png"><a href="/index.php/Home/See/index">我看过谁</a></li>
		  </ul>
		  <div class="clear"></div>
		</div>
		<div class="user_menu_hr"></div>
		...
		<div class="user_menu_item">
		  <ul>
			<li><img src="/Public/images/562711.png"><a href="/index.php/Home/Photo/set">形象照</a></li>
			<li><img src="/Public/images/562793.png"><a href="/index.php/Home/PhotoAlbum/index">我的相册</a><span><a href="/index.php/Home/PhotoAlbum/add">上传</a></span></li>
			<li><img src="/Public/images/562783.png"><a href="/index.php/Home/UserParams/index"><b><font color="red">编辑资料</font></b></a></li>
			<li><img src="/Public/images/562843.png"><a href="/index.php/Home/Choose/index">择友条件</a></li>
		  </ul>
		  <div class="clear"></div>
		</div>
		<div class="user_menu_hr"></div>
		...
		<div class="user_menu_item">
		  <ul>
			<li><img src="/Public/images/562885.png"><a href="/index.php/Home/Diary/index">我的日记</a><span><a href="/index.php/Home/Diary/add">发表</a></span></li>
		  </ul>
		  <div class="clear"></div>
		</div>
		<div class="user_menu_hr"></div>
		...
		<div class="user_menu_item">
		  <ul>
				<li><img src="/Public/images/562875.png"><a href="/index.php/Home/UserPoints/index">积分记录</a></li>
		  </ul>
		  <div class="clear"></div>
		</div>
	</div>
  ...
  <div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  <li class="tab_item current"><a href="/index.php/Home/User/view/act/userInfo">我的帐号</a></li>
		  <li class="tab_item"><a href="/index.php/Home/User/view/act/editPass">修改密码</a></li>
		  <li class="tab_item"><a href="/index.php/Home/User/view/act/receiveEmail">邮件接收</a></li>
		  <li class="tab_item"><a href="/index.php/Home/User/view/act/loveStatus">设置状态</a></li>
	    </ul>
	  </div>
    </div>
	<!--TAB END-->
	...
	<div class="div_smallnav_content_hover">
      ...
      <table class="user-table table-margin lh35" cellpadding="0" cellspacing="0" border="0" width="98%">
		  ...
		  <!-- 会员ID -->
		  <tr>
			<td class="lblock" width="15%">交友ID：</td>
			<td class="rblock" width="85%"><?php echo ($find['id']); ?></td>
		  </tr>
		  <!-- 会员名称 -->
		  <tr>
			<td class="lblock">登录账号：</td>
			<td class="rblock"><?php echo ($find['username']); ?></td>
		  </tr>
		  <!-- Email -->
		  <tr>
			<td class="lblock">登录邮箱：</td>
			<td class="rblock"><?php echo ($find['email']); ?></td>
		  </tr>
		  <!-- 交友状态 -->
		  <tr>
			<td class="lblock">交友状态：</td>
			<td class="rblock">
                        <?php if($item == 1): ?><font color="green">
                        <?php else: ?>
                        <font color="red"><?php endif; ?>
                        <?php echo ($loveSta[$find['lovestatus']]); ?></font>
						&nbsp;&nbsp;&nbsp;
			<input class="button-red" value="修改状态" onclick="javascript:window.location.href='/index.php/Home/User/loveStatus';" type="button">
			</td>
		  </tr>
		  <!-- 会员组 -->
		  <tr>
			<td class="lblock">会员组： </td>
			<td class="rblock"><img src="/Public/images/f2fde8e7d8aa2a10.gif" class="" border="0"> <b><?php if($userother1["jurisdiction"] == 1): ?>VIP会员<?php else: ?>普通会员<?php endif; ?></b>&nbsp;&nbsp;&nbsp;			&nbsp;&nbsp;&nbsp;
			
			<a class="btn_c1" href="<?php echo U('User/vip');?>"><span><font color="blue"><b><?php if($userother1["jurisdiction"] != 1): ?>升级VIP会员服务<?php endif; ?></b></font></span></a></td>
		  </tr>
		  <!-- 剩余积分 -->
		  <tr>
			<td class="lblock">积 分：</td>
			<td class="rblock"><font color="blue"><b><?php echo ($find['points']); ?></b></font> </td>
		  </tr>
		
		  <!-- 注册时间 -->
		  <tr>
			<td class="lblock">注册时间 </td>
			<td class="rblock"><?php echo (date("Y-m-d H:i:s",$find['regtime'])); ?></td>
		  </tr>
		  <!-- 登录次数 -->
		  <tr>
			<td class="lblock">登录次数 </td>
			<td class="rblock"><?php echo ($find['loginviews']); ?>次</td>
		  </tr>
		  <!-- 登录时间 -->
		  <tr>
			<td class="lblock">登录时间 </td>
			<td class="rblock"><?php echo (date("Y-m-d H:i:s",$find['logintime'])); ?></td>
		  </tr>
      </tbody></table>
...
<div id="emface_pannel" class="eif-pannel">
  <div class="emface-border">
	<div class="emface-bg"><a href="###" ><img src="/Public/images/em_close.gif" border="0"></a></div>
	<div class="clear"></div>
...
<div class="user_footer">
  <p>
	&nbsp;红娘客服 &nbsp;24小时服务QQ：<a target="_blank" href="#"><img src="/Public/images/pa.gif" alt="点击这里给我发消息" title="点击这里给我发消息" border="0"></a>&nbsp;
</p>
<p>
...
.popwin-box{
  ...
  bottom:0px; 
  right:0px;
  background:url("/Public/images/popwin_bg.jpg") repeat-x bottom;
...
.popwin-menu .popwin-tx{
	...
	background: url(/Public/images/icon.png) repeat scroll -100px -275px transparent; 
...
.zm_popwin_right {
	...
	<div class="popwin-box">
		  ...
		  <div class="zm_popwin_left">
			<ul>
			  <li style="padding-left:20px;padding-right:10px;" class="zm_popwin_rightbor"><a href="/index.php/Home/User/view/act/userInfo">会员中心</a></li>
			  <li style="padding-left:10px;padding-right:10px;" class="zm_popwin_rightbor"><img src="/Public/images/popwin_avatar.gif"><a href="/index.php/Home/Photo/set">设置形象照</a></li>
			  
			  <li style="padding-left:10px;padding-right:10px;">
				<a href="<?php echo U('User/vip');?>"><img src="/Public/images/cid.png" src="/Public/css/popwin_vip.png" title="VIP服务" /></a>&nbsp;
				<a href="/index.php/Home/Choose/index">修改择友条件</a>
			  </li>
					...
					<div class="popwin-menu">
						<ul id="uuid">
							  <li onclick="obj_click_menu('msg', '2', '我的信件');">
									<img src="/Public/images/popwin_letter.gif">信件
									<span id="popwinmsg"></span>
							  </li>

							  <li onclick="obj_click_menu('hi', '1', '我的招呼');">
									<img src="/Public/images/popwin_hi.gif">招呼
									<span id="popwinhi">
							  ...
							  <li onclick="obj_click_menu('gift', '3', '我的礼物');">
									<img src="/Public/images/popwin_gift.gif">礼物
									<span id="popwingift">
										
									</span>
							  </li>
							  <li onclick="obj_click_menu('sysmsg', '1', '我的消息');">
									<img src="/Public/images/popwin_gg.gif">消息
