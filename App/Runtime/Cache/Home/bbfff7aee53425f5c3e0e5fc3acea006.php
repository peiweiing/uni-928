...
<div class="tab_list">
  <div class="tab_nv">
	<ul>
	  <li class="tab_item current"><a href="/yyw/index.php/Home/Message/index">会员来信</a></li>
	...
	<div class="div_smallnav_content_hover">
	  <div class="nav-tips">
	    <div class="span" id="total">收到信件<?php echo ((isset($total) && ($total !== ""))?($total):0); ?>封</div>
	    筛选排序：
	    <img src="/yyw/Public/images/tips-msg01.gif"><a href="/yyw/index.php/Home/Message/index/status/1">未读信件</a> &nbsp;&nbsp;&nbsp;
	    <img src="/yyw/Public/images/tips-msg02.gif"><a href="/yyw/index.php/Home/Message/index/status/2">已读信件</a>&nbsp;&nbsp;&nbsp;
	  ...
	  <table class="table">
		...
		<tr>
		  ...
		  <td width="12%">状态</td>
		  <td width="10%"></td>
		  <td width="40%" align="left">发信人信息</td>
		  <td width="10%">操作</td>
		  <td width="21%">时间</td>
		</tr>
		<?php if($total == 0): ?><tr>
		  <td colspan="6" class="hback" align="center">对不起，暂时没有信件。</td>
		</tr>
		<?php else: ?>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
		  ...
		  <td><a href="/yyw/index.php/Home/Message/receiveView/id/<?php echo ($list["id"]); ?>" class="letter-button5"></a></td>
		...
		<tr>
			<td colspan="5" style="text-align:left;">
				...
				<input type="submit" value="删除选定" class="button-red" onclick="messageDel('Message','receivedel')"/>
			</td>
		</tr><?php endif; ?>
