...
<div class="search_max w960 online_page">
	...
	<div class="search_top">
		...
		<div class="search_in">
			...
			<?php $__FOR_START_28904__=18;$__FOR_END_28904__=61;for($i=$__FOR_START_28904__;$i < $__FOR_END_28904__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
			</select>
			...
			<option value="">不限</option>
			<?php $__FOR_START_29441__=18;$__FOR_END_29441__=61;for($i=$__FOR_START_29441__;$i < $__FOR_END_29441__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
			</select>
	...
	<div class="search_sort">
      <div class="search_tips"> 共<span><?php echo ($total); ?></span>人符合您的搜索条件 </div>
      <div class="search_sort_sle" id="rank"> 
	    <strong>显示方式：</strong> 		
	    <a class="btnc btn_c3" href="/yyw/index.php/Home/UserList"> <span class="h"><b>头像模式</b></span> </a>&nbsp;
		<a class="btnc3 btn_c3" href="/yyw/index.php/Home/UserList/index/type/mon"> <span><b>独白模式</b></span> </a> 
	  </div>
    </div>

	<div class="online_list">
	<?php if($total == '0'): ?><div style="text-align:center">
			<h3>sorry！没有您要搜索的会员！</h3>
		</div>
	  <?php else: ?>
      <ul class="search_pic_list clearfix">  
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li>
          <div class="search_user_bg"> <a target="_blank" href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($list["userid"]); ?>"><img src="/yyw/Public/Uploads/pic/<?php echo ($list["user"]["avatar"]); ?>" class="img100" height="135" width="112"></a> </div>
          <div class="search_user_inform">
            <p class="search_user_t1"><img src="/yyw/Public/images/<?php echo ($list["icon"]); ?>" class="" border="0"><a target="_blank" href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($list["userid"]); ?>"><?php echo ($list["user"]["username"]); ?></a> </p>
            <p class="search_user_add"><?php echo ($list["age"]); ?>岁 <?php echo ($list["provinceid"]); ?> <?php echo ($list["cityid"]); ?></p>
            <p class="search_vt"> 
				<a class="btn_bt1 chat sayHiBtn" href="javascript:void(0);" onclick="showBox('greet',<?php echo ($list["userid"]); ?>)"><span><img src="/yyw/Public/images/d.gif"></span></a> 
				<a class="btn_bt2 mail sendEmailBtn" href="javascript:void(0);" onclick="showBox('message',<?php echo ($list["userid"]); ?>);"><span><img src="/yyw/Public/images/r.gif"></span></a>
			</p>
          </div>
	...
	<div class="onrightad"><a><img src="/yyw/Public/images/e3c71d7ebaa2745f.png" title="" border="0" height="102" width="220"></a></div>
	  
      <div class="divtitle">推荐会员</div>
      <div class="onhead">
		<?php if(is_array($recuser)): $i = 0; $__LIST__ = $recuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rec): $mod = ($i % 2 );++$i;?><div class="odh">
		  <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($rec["userid"]); ?>" target="_blank">
		  <img src="/yyw/Public/Uploads/pic/<?php echo ($rec["user"]["avatar"]); ?>" border="0" height="86" width="70"></a><br>
		  <img src="/yyw/Public/images/<?php echo ($rec["icon"]); ?>" class="" border="0">
          <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($rec["userid"]); ?>" target="_blank"><?php echo ($rec["user"]["username"]); ?></a>
		</div><?php endforeach; endif; else: echo "" ;endif; ?>     
		<div style="clear:both;"></div>
      </div>
      <div class="divtitle" style="margin-top:5px;">最新日记</div>
      <ul class="list_so">
		<?php if(is_array($newdiary)): $i = 0; $__LIST__ = $newdiary;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newdiary): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="/yyw/index.php/Home/DiaryShow/single/id/<?php echo ($newdiary["id"]); ?>" title="<?php echo ($newdiary["title"]); ?>"><?php echo ($newdiary["title"]); ?></a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
	  </ul>
      <div class="divtitle" style="margin-top:5px;">猜你喜欢</div>
      <div class="onhead">
		<?php if(is_array($gueuser)): $i = 0; $__LIST__ = $gueuser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gue): $mod = ($i % 2 );++$i;?><div class="odh">
		  <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($gue["userid"]); ?>" target="_blank"><img src="/yyw/Public/Uploads/pic/<?php echo ($gue["user"]["avatar"]); ?>" border="0" height="86" width="70"></a><br>
          <img src="/yyw/Public/images/<?php echo ($gue["icon"]); ?>" class="" border="0">
		  <a href="/yyw/index.php/Home/HomePage/index/id/<?php echo ($gue["userid"]); ?>" target="_blank"><?php echo ($gue["user"]["username"]); ?></a>
		</div><?php endforeach; endif; else: echo "" ;endif; ?>
		        
		<div style="clear:both;"></div>
      </div>

	  	  	  <div class="onrightad"><a><img src="/yyw/Public/images/ec1db26e7d73e3e0.png" title="" border="0" height="102" width="220"></a></div>
