...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/SystemMessage';
</script>
...
<div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  ...
		  <li class="tab_item current"><a href="/yyw/index.php/Home/SystemMessage/index">系统消息</a></li>
	    </ul>
	  </div>
    </div>
	<!--TAB END-->
    <div class="div_smallnav_content_hover">
	  	  ...
	  	  <div class="nav-tips">
	    <div class="span">共<?php echo ($totalCount); ?>条消息</div>
	    筛选排序：
	    <img src="/yyw/Public/images/tips-msg01.gif"><a href="/yyw/index.php/Home/SystemMessage/index/type/unread">未读消息</a> &nbsp;&nbsp;&nbsp;
	    <img src="/yyw/Public/images/tips-msg02.gif"><a href="/yyw/index.php/Home/SystemMessage/index/type/read">已读消息</a>&nbsp;&nbsp;&nbsp;
	  </div>
	  <form action="/yyw/index.php/Home/SystemMessage/del" method="post" onsubmit="return doDelete();" name="myform" id="myform">
	  ...
	  <table class="table">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td>
                    <input class="item" value="<?php echo ($vo['id']); ?>" type="checkbox">
                    <?php if($vo['status'] == 1): ?><img src="/yyw/Public/images/tips-msg01.gif" title="未读消息" alt="未读消息">
                    <?php else: ?>
                    <img src="/yyw/Public/images/tips-msg02.gif" title="已读消息" alt="已读消息"><?php endif; ?>
                </td>
                <td style="text-align:left;">系统管理员</td>
                <td style="text-align:left;">
                    <a href="/yyw/index.php/Home/SystemMessage/detail/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a>
                </td>
                <td><?php echo (date("Y-m-d H:i:s",$vo['addtime'])); ?></td>
                <td align="left"><a href="/yyw/index.php/Home/SystemMessage/detail/id/<?php echo ($vo['id']); ?>">查看</a></td>
