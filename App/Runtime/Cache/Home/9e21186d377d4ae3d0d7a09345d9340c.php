...
<div class="user_main">
  ...
  <div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  <li class="tab_item current"><a href="/yyw/index.php/Home/User/view/act/userInfo">我的帐号</a></li>
		  ...
		  <li class="tab_item"><a href="/yyw/index.php/Home/User/view/act/loveStatus">设置状态</a></li>
	    </ul>
	  </div>
    </div>
	<!--TAB END-->
      ...
      <table class="user-table table-margin lh35" cellpadding="0" cellspacing="0" border="0" width="98%">
		  ...
		  <tr>
			...
			<td class="rblock">
						...
						&nbsp;&nbsp;&nbsp;
			<input class="button-red" value="修改状态" onclick="javascript:window.location.href='/yyw/index.php/Home/User/loveStatus';" type="button">
			</td>
		  </tr>
		  <!-- 诚信星级 -->
		  <tr>
			...
			<td class="rblock">
			  ...
			  <img src="/yyw/Public/images/mobile_h.png" title="手机未认证">
			  &nbsp;&nbsp;&nbsp;
			  <input class="button-green" value="诚信认证" onclick="javascript:window.location.href='/usercp.php?c=certify';" type="button">
			</td>
		  </tr>
		  <!-- 会员组 -->
		  <tr>
			<td class="lblock">会员组： </td>
			<td class="rblock"><img src="/yyw/Public/images/f2fde8e7d8aa2a10.gif" class="" border="0"> <b>普通会员</b>&nbsp;&nbsp;&nbsp;			&nbsp;&nbsp;&nbsp;
			
			<a class="btn_c1" href="#"><span>升级会员服务</span></a></td>
		  </tr>
		  <!-- 剩余积分 -->
		  <tr>
		  ...
		  <tr>
			...
			<td class="rblock"><font color="green"><b>0.00</b></font> &nbsp;&nbsp;&nbsp;
			<input value="在线充值" class="button-qing" onclick="javascript:window.location.href='#';" type="button">&nbsp;&nbsp;&nbsp;
						</td>
		  </tr>
		  <!-- 注册时间 -->
		  <tr>
