...
<script type="text/javascript">
	...
	var __url__ = '/yyw/index.php/Home/ByAttention';
</script>
...
<div class="user_main">
  ...
  <div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  <li class="tab_item"><a href="/yyw/index.php/Home/Attention/index">我的关注</a></li>
		  <li class="tab_item current"><a href="/yyw/index.php/Home/ByAttention/index">我的粉丝</a></li>
    ...
    <div class="div_smallnav_content_hover" style='width:780px;border:1px solid #ddd' >
		...
		<tbody><tr>
		<?php if($users == null): ?><td align="center">对不起，你还被任何人关注！</td>
		 <?php else: ?>
	  ...
	  <?php if($users[0][username] == ''): ?><center></center>
	  <?php else: ?>
	  <center><?php echo ($pageInfo); ?></center><?php endif; ?>
	  <div class="page1">
        <div class="pagecode">
		<?php echo ($pageInfo); ?>
        </div>
