...
<div class="main_right">
    ...
    <div class="tab_list">
	  <div class="tab_nv">
	    <ul>
		  ...
		  <li class="tab_item current"><a href="/yyw/index.php/Home/User/view/act/receiveEmail">邮件接收</a></li>
	...
	<div class="div_smallnav_content_hover">
	  	  ...
	  	  <form name="myform" action="/yyw/index.php/Home/User/update/type/receiveEmail" method="post">
	  <table class="user-table table-margin lh35" cellpadding="0" cellspacing="0" border="0" width="98%">
		  ...
		  <tr>
			...
			只有通过认证的邮箱才可以接收邮件。<a href="http://localhost:8091/usercp.php?c=certify&amp;a=email">邮箱认证</a>
			</td>
		  </tr>
		  <tr>
			<td class="lblock" width="10%"></td>
			<td class="rblock" width="90%">开启 
                <input name="emailstatus" type="radio" id="recall" value="1" <?php if($esta == 1): ?>checked="checked"<?php endif; ?> />
                <span id="drecall" class="f_red"></span></td>
		  </tr>
		  <tr>
			<td class="lblock"></td>
			<td class="rblock">关闭 
                <input name="emailstatus" type="radio" id="recall" value="0" <?php if($esta == 0): ?>checked="checked"<?php endif; ?> />  
                <span id="drecall" class="f_red"></span></td>
		  </tr>
		  <!-- 提交保存 -->
		  <tr>
        ...
        /*
            $(function(){
                $('form').submit(function(){
                    $(this).attr('action', $(this).attr('action')+'/refesh/'+Math.random());
